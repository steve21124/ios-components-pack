...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    //Left Controller
    SlideOutMenuController *slideMenuController = [storyboard instantiateViewControllerWithIdentifier:@"SlideOutMenuController"];
    ...
    //self.viewController.centerPanel = [[UINavigationController alloc] initWithRootViewController:[[KMHomeController alloc] init]];
